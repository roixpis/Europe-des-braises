...
static const float  WATER_HEIGHT = 9.6f; // was 9.5f
...
static const float GB_CAM_MAX_FILLING_CLAMP = 1.0; // 0 to 1 value for clamping the fill when camera is at max distance
...
static const float GB_STRENGTH_CH2 = 0.85; // Opacity of top layer
static const float GB_FIRST_LAYER_PRIORITY = 0.75; // Priority for first/second layer when both are active at the same pixel
...
static const float4 RIM_COLOR 		= float4( 1.0f, 0.0f, 0.0f, 0.0f );
